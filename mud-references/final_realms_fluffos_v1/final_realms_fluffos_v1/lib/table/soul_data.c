...
string global_adj = ",slowly,happily,sadly,nervously,wryly,broadly,crookedly,"+
...
([ 
  ...
  "frown" : ({ ({ 3, "%s", 3, "in %s" }), ({
      ...
      "depression,like a cat,happily,#$$else$You frown~$",
  ...
  "laugh" : ({ ({
      ...
      "happily,hysterically,maniacally,ecstatically,demonically$"+
      "$else$You laugh~$",
  ...
  "nod" : ({ ({
      ...
      2, "%s %s", 3, "%s" }), ({
      "You nod$ifarg: $arg:solemnly,happily,brightly,curtly,"+
