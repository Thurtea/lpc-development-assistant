...
void setup()  {
  ...
  set_short("%^BOLD%^GREEN%^Crylian Forest : Shrine of Chaotic Good%^RESET%^");
 
  set_long("\n%^BOLD%^GREEN%^Crylian Forest : Shrine of Chaotic Good%^RESET%^\n\n"
  ...
  set_god_here("hokemj");
  //add_exit("northwest","/d/of/n_forest/paths/path15.c","path");
}  /* setup */
