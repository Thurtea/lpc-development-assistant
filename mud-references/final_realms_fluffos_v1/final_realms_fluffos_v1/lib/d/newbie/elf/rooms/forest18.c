...
void setup() {
    ...
    "     A dense forest spreads out to the south, west and north.  "
    ...
    add_item("leaf", "The green leaves spreading above you glimmer in the "
             "filtered sunlight.\n");
    add_exit("north", ROOM+ "forest23", "plain");
    add_exit("south", ROOM+ "forest14", "plain");
    add_exit("west", ROOM+ "forest17", "plain");
