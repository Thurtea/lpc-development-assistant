...
void setup() {
    add_property("no_undead",1); set_short("Realm of the Elf:  Forest");
   set_long("\n   Realm of the Elf:  Forest.\n\n"
            "     You stand before a huge-boled tree.  As you gaze up "
            "its trunk, "
    ...
    add_item("bough", "Thick branches spread above your head, their leaves "
              "providing a natural ceiling for this forest.\n");
    add_exit("east", ROOM+ "forest11", "plain");
  add_exit("up","/d/newbie/elf/cafe/cafeb.c","hidden");
