...
void setup() {
    ...
    set_long("Realm of the Elf:  Gloomy Forest\n\n"
    "     The silence of this forest strikes you as a bit unusual.  "
         "There seems to be very little animal life here.\n");
    ...
    add_item("leaf", "The green leaves spreading above you glimmer in the "
             "filtered sunlight.\n");
    add_exit("north", ROOM+ "forest17", "plain");
    add_exit("south", ROOM+ "forest9", "plain");
    add_exit("east", ROOM+ "forest14", "plain");
    add_exit("west", ROOM+ "forest12", "plain");
