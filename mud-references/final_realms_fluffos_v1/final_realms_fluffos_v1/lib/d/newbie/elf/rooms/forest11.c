...
void setup() {
    ...
    "     The breeze is cool under the thick boughs spreading above "
         "your head.  The forest is pleasant here.\n");
    ...
    add_item("bough", "Thick branches form a natural ceiling for this "
              "part of the forest.\n");
    add_exit("north", ROOM+ "forest16", "plain");
    add_exit("south", ROOM+ "forest7", "plain");
  add_exit("west",ROOM+"cafea","path");
    add_exit("east", ROOM+ "forest12", "plain");
