...
void setup() {
    ...
    "     A dense forest spreads out to the north, south and west.  "
         "It appears well-kept but you see no signs of habitation.\n");
    ...
    add_exit("north", ROOM+ "forest18", "plain");
    add_exit("south", ROOM+ "forest10", "plain");
    add_exit("west", ROOM+ "forest13", "plain");
