...
void setup() {
    ...
    "     A dense forest spreads out to the north, west and south.  "
    ...
    add_item("leaf", "The green leaves spreading above you glimmer in the "
             "filtered sunlight.\n");
    add_exit("north", ROOM+ "forest14", "plain");
    add_exit("south", ROOM+ "forest5", "plain");
    add_exit("west", ROOM+ "forest9", "plain");
