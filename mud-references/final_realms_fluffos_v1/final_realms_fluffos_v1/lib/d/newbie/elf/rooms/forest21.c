...
void setup() {
    ...
    "     The silence of this forest seems unusual to you.  There "
         "seems to be very little animal life here.\n");
    ...
    add_item("leaf", "The green leaves spreading above you glimmer in the "
             "filtered sunlight.\n");
    add_exit("north", ROOM+ "fo28", "plain");
    add_exit("south", ROOM+ "smithya", "plain");
    add_exit("east", ROOM+ "forest22", "plain");
    add_exit("west", ROOM+ "forest20", "plain");
