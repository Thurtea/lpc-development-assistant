...
void setup()
{
    ...
    set_short("Galastriia :  Raiseroom");
    set_save_file(file_name(this_object()));
    set_long("\nGalastriia :  Raiseroom.\n\n"
      "     This small chapel is for the brave elves defeated in battle to come for a "
    ...
    add_exit("north",ROOMS+"elf1.c","path");
    add_exit("south",ROOMS+"aaroc_center.c","path");
}
