...
set_long("You are in the great maze.  The room is squareish in shape and "
    ...
    "  To the north is a stair going up while to the west is one going "
    "down."
      "\n");
add_smell("room", "It smells old.\n");
add_taste("air", "The air tastes Musty and old.");

add_exit("north",MAZE+"maze09","stair");
add_exit("east",MAZE+"maze17","door");
add_exit("west",MAZE+"maze31","stair");

add_clone(CHAR+"capdwarf1",random(3));
