...
set_long("You are in the great maze.  The room is squareish in shape and "
    ...
    "  There is a stair leading down to the south, while there is a "
    "stair going up to the west."
      "\n");
add_smell("room", "It smells old.\n");
add_taste("air", "The air tastes Musty and old.");

add_exit("north",MAZE+"smaze06","door");
add_exit("south",MAZE+"maze13","stair");
add_exit("west",MAZE+"maze03","stair");
