...
set_long("You are in the great maze.  The room is squareish in shape and "
    ...
    "  To the north is a stair going down while to the south is one "
    "going up."
      "\n");
add_smell("room", "It smells old.\n");
add_taste("air", "The air tastes Musty and old.");

add_exit("north",MAZE+"maze37","stair");
add_exit("south",MAZE+"maze11","stair");
add_exit("east",MAZE+"maze20","door");
