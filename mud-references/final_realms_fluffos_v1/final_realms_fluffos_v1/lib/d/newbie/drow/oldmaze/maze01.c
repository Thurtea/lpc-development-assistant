...
set_long("You are in the great maze.  The room is squareish in shape and "
    ...
    "  There is a stair leading down to the west."
      "\n");
add_smell("room", "It smells old.\n");
add_taste("air", "The air tastes Musty and old.");

add_exit("west",MAZE+"maze","door");
add_exit("north",MAZE+"maze02","door");
add_exit("east",MAZE+"smaze01","door");
add_exit("guild",MAZE+"guild","door");
add_exit("stairs",MAZE+"maze04","stair");
