...
set_long("You are in the great maze.  The room is squareish in shape and "
     ...
     "and it seems to give the a musty smell that you can taste."
      "\n");
add_smell("room", "It smells old.\n");
add_taste("air", "The air tastes Musty and old.");

add_exit("north",MAZE+"maze54","door");
add_exit("south",MAZE+"maze44","door");

add_clone(CHAR+"caphum2", random(4));
