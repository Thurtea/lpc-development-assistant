...
add_exit("north",NEWBIE+"dlev3_09","path");
add_exit("south",NEWBIE+"dlev3_14","path");
add_exit("east",NEWBIE+"dlev3_05","path");
add_exit("west",NEWBIE+"dlev3_10","path");
add_exit("southeast",NEWBIE+"dlev3_15","path");
}
