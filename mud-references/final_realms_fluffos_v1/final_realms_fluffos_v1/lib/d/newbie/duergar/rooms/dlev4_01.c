...
void setup() {
   ...
   add_exit("south", NEWBIE+"dlev4_10", "path");
   add_exit("east",NEWBIE+"dlev4_04","path");
   add_exit("northeast",NEWBIE+"dlev4_03","path");
   add_exit("northwest",NEWBIE+"dlev4_02","path");
   add_exit("southeast",NEWBIE+"dlev4_05","path");
   add_exit("southwest",NEWBIE+"dlev4_00","door");
}
