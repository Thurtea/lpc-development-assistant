...
add_exit("north",NEWBIE+"dlev3_05","path");
add_exit("south",NEWBIE+"dlev3_20","path");
add_exit("east",NEWBIE+"dlev3_16","path");
add_exit("west",NEWBIE+"dlev3_14","path");
add_exit("northwest",NEWBIE+"dlev3_11","path");
}
