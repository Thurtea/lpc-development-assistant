...
void setup() {
   ...
   add_exit("north",NEWBIE+"dlev4_08","path");
   add_exit("south",NEWBIE+"dlev4_16","path");
   add_exit("east",NEWBIE+"dlev4_12","path");
   add_exit("west",NEWBIE+"dlev4_05","path");
   add_exit("southwest",NEWBIE+"dlev4_15","path");
}
