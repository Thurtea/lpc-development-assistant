...
void setup()
 {
    ...
    "see the forest surounding the elven village. Below you "
    "see some people doing their daily work carving and making of " 
    "clothes. To the right you notice a big majestetic oaktree.\n");   
    ...
    add_exit("north","/d/newbie/half-elf/t5.c","door");    
    add_exit("southeast","/d/newbie/half-elf/v9.c","door");
