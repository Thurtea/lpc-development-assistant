...
void setup()
 {
    ...
    add_item("window","Looking through the northern open window you
    see the forest surounding the elven village. Just below you
    see a small hut looking like a temple with the walls 
    filled with strange carvings. Up to the right there
    seems to be a guard post with an armed archer.   \n");   
    ...
    add_exit("southeast","/d/newbie/half-elf/y3.c","door");    
    add_exit("southwest","/d/newbie/half-elf/t3.c","door");
